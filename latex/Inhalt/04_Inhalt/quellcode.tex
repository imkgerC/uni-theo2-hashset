...
\lstinputlisting[label=code:main, caption=main.rs, language=Python]{../src/main.rs}
\lstinputlisting[label=code:mod, caption=mod.rs, language=Python]{../src/hashset/mod.rs}
\lstinputlisting[label=code:hashing, caption=hashing.rs, language=Python]{../src/hashset/hashing.rs}
\lstinputlisting[label=code:probing, caption=probing.rs, language=Python]{../src/hashset/probing.rs}
